    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sm.registerListener(object : SensorEventListener {
            override fun onSensorChanged(event: SensorEvent) {
                x = dna.setX(event.values[0].toDouble(), event.values[1].toDouble(), event.values[2].toDouble())
                y = dna.setY(event.values[0].toDouble(), event.values[1].toDouble(), event.values[2].toDouble())
                z = dna.setZ(event.values[0].toDouble(), event.values[1].toDouble(), event.values[2].toDouble())
